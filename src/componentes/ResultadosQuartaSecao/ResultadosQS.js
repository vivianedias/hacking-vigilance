    ...
    render() {
        let primeiraPergunta;
            if (localStorage.getItem("quartaSecaoPrimeiraPergunta") === "nao"){
                primeiraPergunta =
                    <div>
                        <h3 className="answerTitle">Linux é amor</h3>
                            <ul className="answerContent">
                                ...
                                <li>
                                    ...
                                    <p>Qual a diferença entre Windows e Linux?</p>
                                <li>
                                    ...
                                    Você não precisa pagar nada para usar o Linux! Não é crime fazer cópias para instalá-lo em outros computadores. A vantagem de um sistema 
                                ...
                                <p>Porque trocar de Sistema Operacional?</p>
                                <ol>
            ...
            if (localStorage.getItem("quartaSecaoSegundaPergunta") === "nao"){
                segundaPergunta = 
                    <div>
                        <h3 className="answerTitle">Você pode estar sendo espionado</h3>
                        <ul className="answerContent">
                            <li>
